...
public class PlayerMovement : MonoBehaviour
{
    ...
    public void Jump(InputAction.CallbackContext context)
    {
        ...
        {
            // Calculate the required velocity for a jump
    ...
    private void MovePlayer()
    {
        ...
        {
            // when falling down increment velocity with gravity and time
        ...
        // Apply gravity constantly to enable jumping
    ...
    private void HandleStamina()
    {
        ...
        if (isSprinting && currentStamina > 0)
        {
            ...
            {
                currentStamina = 0;
                isSprinting = false; // Stop sprinting if stamina depletes
            }
        }
